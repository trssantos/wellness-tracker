  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <input
        ...
        className="flex-1 p-2 border border-slate-200 dark:border-slate-700 rounded-md bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-200 text-sm transition-colors"
