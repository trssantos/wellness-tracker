...
const BucketList = () => {
      ...
      case 'goals':
        return (
          <div className="space-y-4 w-full">
            ...
            <div className="bg-white dark:bg-slate-800 p-3 sm:p-4 rounded-xl shadow-sm flex flex-col gap-3 w-full">
            ...
            {/* Goals list */}
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm overflow-hidden w-full">
              {getFilteredGoals().length === 0 ? (
                ...
                <div className="divide-y divide-slate-200 dark:divide-slate-700 w-full">
                  {getFilteredGoals().map(goal => (
                    <div 
                      key={goal.id}
                      className="p-4 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors w-full"
                    >
  ...
  return (
    <div className="relative w-full flex flex-col" style={{ width: '100%', maxWidth: '100%', minWidth: '100%' }}>
 
      {/* Header with navigation tabs - always visible */}
      <div className="mb-6 w-full">
        <div className="w-full flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-slate-800 p-4 md:p-6 rounded-xl shadow-sm">
          <div>
        ...
        <div className="sm:hidden bg-white dark:bg-slate-800 p-3 rounded-xl shadow-sm mt-3 w-full">
          <div className="relative w-full">
            <select
              value={activeTab}
        ...
        <div className="hidden sm:block bg-white dark:bg-slate-800 rounded-xl shadow-sm overflow-hidden mt-3 w-full">
