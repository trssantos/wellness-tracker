            ...
            <div className="bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm flex flex-col md:flex-row gap-3">
              ...
              <div className="flex gap-2">
                <div className="relative">
                  ...
                  <List className="absolute left-2 top-2.5 text-slate-400" size={16} />
                  <ChevronDown className="absolute right-2 top-2.5 text-slate-400" size={16} />
                </div>
                <button
              ...
              {getFilteredGoals().length === 0 ? (
                ...
                <div className="divide-y divide-slate-200 dark:divide-slate-700">
                  {getFilteredGoals().map(goal => (
                    <div 
                      key={goal.id}
                      className="p-4 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors flex items-center gap-3"
                    >
                      <button
