  ...
  const validateForm = () => {
    ...
    if (categories.length === 0) {
      ...
      if (duplicates.length > 0) {
        newErrors.duplicateTasks = `Duplicate task names found: ${duplicates.join(', ')}. Each task must have a unique name.`;
      }
    }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm p-6 transition-colors">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-xl font-semibold text-slate-800 dark:text-slate-100 ml-4 transition-colors">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="space-y-4 mb-6">
            <div>
              ...
              <input
                ...
                placeholder="E.g., Morning Routine, Work Day, House Cleaning"
              />
            </div>
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-medium text-slate-700 dark:text-slate-300">Categories & Tasks</h2>
              <button
                type="button"
                onClick={addCategory}
                className="flex items-center gap-1 px-3 py-1 bg-teal-50 dark:bg-teal-900/30 text-teal-600 dark:text-teal-400 rounded-lg hover:bg-teal-100 dark:hover:bg-teal-900/50 transition-colors"
              >
                <PlusCircle size={16} />
            ...
            <div className="space-y-6">
              {categories.map((category, catIndex) => (
                <div key={catIndex} className="border border-slate-200 dark:border-slate-700 rounded-lg p-4">
                  <div className="flex items-center mb-4">
                    ...
                    <button
                      ...
                      className="ml-2 p-2 text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-lg"
                  ...
                  <div className="space-y-2 ml-4 pl-2 border-l-2 border-slate-200 dark:border-slate-700">
                    {category.items.map((task, taskIndex) => (
                      <div key={taskIndex} className="flex items-center">
                        ...
                        <input
                          ...
                          className="flex-1 p-2 border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-200"
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300 mt-2"
                    >
                      <PlusCircle size={14} />
                      <span>Add Task</span>
                    </button>
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              type="submit"
              className="px-4 py-2 bg-teal-500 dark:bg-teal-600 text-white rounded-lg hover:bg-teal-600 dark:hover:bg-teal-700 transition-colors flex items-center gap-2"
            >
              <Save size={16} />
